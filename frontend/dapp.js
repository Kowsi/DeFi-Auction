...
const contractAddress = "0xc93642ad092BE41F5B7577cFd309641A486984ab";
...
const dApp = {
  ...
  main: async function() {
    ...
    console.log(this.marsContract.methods.owner)
    this.isAdmin = this.accounts[0] == await this.marsContract.methods.owner().call().then(console.log);
